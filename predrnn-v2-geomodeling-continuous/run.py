...
import numpy as np
import math
from core.data_provider import dataset_fold_continuous
...
def train_wrapper(model):
    ...
    train_input_handle, test_input_handle = dataset_fold_continuous.data_provider(train_batch_size=args.batch_size, test_batch_size=1,
                                                                                   path='./core/data_provider/Continuous_3D_Model')

    eta = args.sampling_start_value
    itr = 1

    for epoch in range(55, args.max_iterations + 1):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gen_frm_dir', type=str, default='./results/fold_continuous_predrnn_v2')
